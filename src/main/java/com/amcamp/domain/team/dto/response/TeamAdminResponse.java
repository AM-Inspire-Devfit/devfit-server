...
import com.amcamp.domain.team.dao.TeamAdminProjection;
...
public record TeamAdminResponse(
    ...
    public static TeamAdminResponse from(TeamAdminProjection team) {
        return new TeamAdminResponse(team.getId(), team.getNickname(), team.getProfileImageUrl());
    }
}
