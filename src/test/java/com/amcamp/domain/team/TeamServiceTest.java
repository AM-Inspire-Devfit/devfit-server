...
//			String inviteCode = inviteCodeService.generateCode(savedTeam.getId());
//
//			//when & then
//			CommonException exception = assertThrows(CommonException.class, () -> teamService.joinTeam(inviteCode));
//			Assertions.assertEquals(TeamErrorCode.MEMBER_ALREADY_JOINED, exception.getErrorCode());
//		}
//
//
//		@Test
